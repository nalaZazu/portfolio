...
export const projectsData = [
  {
    id: 1,
    projectName: "Vines Market",
    projectDesc:
      "This project seeks to woking on the wines purchase the wines form the online store with NFT with wallet currency.",
    tags: ["Javascript", "Next js","Typscript","Tailwind CSS"],
    code: "https://github.com/sreerag-rajan/historythroughmovies",
    demo: "https://vinesia.com/",
    image:
